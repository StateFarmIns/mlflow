...
export const listExperimentsPayload = ({
    maxResults,
    pageToken,

}) =>
    MlflowService.listExperiments({
        max_results: maxResults || SEARCH_MAX_RESULTS,
        page_token: pageToken
    })

export const LIST_EXPERIMENTS_API = 'LIST_EXPERIMENTS_API';
export const listExperimentsApi = (params) => {
    return {
        type: LIST_EXPERIMENTS_API,
        payload: listExperimentsPayload(params),
        meta: { id: params.id || getUUID() },
    };
};

export const searchExperimentsPayload = ({
    viewType,
    maxResults,
    orderBy,
    filter,
